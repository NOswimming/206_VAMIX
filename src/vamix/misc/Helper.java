...
public class Helper {
	...
	public static final String DEFAULT_FILE = HOME + SLASH + ".vamix" + SLASH + "log";
	...
	public static String checkType(File f) {
		ProcessBuilder builder = new ProcessBuilder("file", "--mime-type", f.getPath());
	...
	/**
	 * 
	 * Turns integer representations of minutes and seconds into
	 * a string of xx:xx:xx form
	 * 
