...
public class DownloadModule extends JPanel {
	...
	public void done(int exitValue) {
		switch(exitValue) {
		case 1:
			JOptionPane.showMessageDialog(this, name + " Failed: Error code 1, cause unknown, general error, sorry.");
			break;
		case 2:
			JOptionPane.showMessageDialog(this, name + " Failed: Parse Error");
			break;
		case 3:
			JOptionPane.showMessageDialog(this, name + " Failed: File I/O Error");
			break;
		case 4:
			JOptionPane.showMessageDialog(this, name + " Failed: Network failure (Probably just Uni WiFi");
			break;
		case 5:
			JOptionPane.showMessageDialog(this, name + " Failed: SSL Verification failure");
			break;
		case 6:
			JOptionPane.showMessageDialog(this, name + " Failed: Username/Password Authentication failure");
			break;
		case 8:
			JOptionPane.showMessageDialog(this, name + " Failed: Server issued an error response");
			break;
		case 7:
			JOptionPane.showMessageDialog(this, name + " Failed: Protocol Errors");
			break;
		default:
			break;
		}
