		...
		contentPane.setLayout(new BorderLayout(0, 0));
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(e.getSource() == btnDownload) {
					...
					if(textField_URL.getText() == null && textField_fileName.getText() == null
							|| textField_URL.getText().equals("") && textField_fileName.getText().equals("")) {
						JOptionPane.showMessageDialog(this, "Please complete both URL and Filename fields.");
						return;
					}
					DownloadModule d1 = new DownloadModule(textField_URL.getText(), textField_fileName.getText());
